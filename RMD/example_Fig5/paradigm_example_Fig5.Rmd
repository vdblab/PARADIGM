...
tblantibiotics_duke = read.csv("../../data/21445161/tblantibiotics_master_table_Duke_142patients_day-14to14_102422.csv")
...
tblpatient = read.csv("../../data/21445161/tblpatient_cohort_characteristics_master_table_deid_MSKCC_778_discovery_423_validation_142_Duke_102422.csv")
...
tblresponse_score = read.csv("../../data/21445176/tblresponse_scores_4microbiome_features_2039samples_102422.csv")
