...
We created two data frames, one containing the response variable
...
We calculated coefficients of predictors to cluster self and attractor
...
![](paradigm_example_Fig3_bc_files/figure-gfm/FigS3_self-1.png)<!-- -->
